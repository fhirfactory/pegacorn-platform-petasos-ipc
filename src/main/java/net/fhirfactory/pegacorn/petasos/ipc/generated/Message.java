...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8815156195961922654L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"net.fhirfactory.pegacorn.petasos.ipc.generated\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
   ...
   */
  public static net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder newBuilder() {
    return new net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder newBuilder(net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder other) {
    if (other == null) {
      return new net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder();
    } else {
      return new net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder newBuilder(net.fhirfactory.pegacorn.petasos.ipc.generated.Message other) {
    if (other == null) {
      return new net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder();
    } else {
      return new net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.fhirfactory.pegacorn.petasos.ipc.generated.Message other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder clearTo() {
      to = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder clearFrom() {
      from = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.fhirfactory.pegacorn.petasos.ipc.generated.Message.Builder clearBody() {
      body = null;
